...
const VENUES = {
  motorco: {
    name: 'Motorco Music Hall', city: 'Durham', color: 'purple', tier: 1,
    seatgeekSlug: 'motorco-music-hall',
  ...
  catscradle: {
    name: "Cat's Cradle", city: 'Carrboro', color: 'magenta', tier: 1,
    seatgeekSlug: 'cats-cradle',
